"""
Setup 2 experiments — comprehensive parameter sweep.
Lock=impression 1, Test=ALL other impressions (2-8), min_iris=8.
...
def main():
    ...
    csv_path = RESULTS_DIR / f"setup2_results_{timestamp}.csv"
    ...
    for db_name in DATABASES:
        print(f"\n{'='*80}")
        print(f"DATABASE: {db_name} | SETUP 2")
        print(f"{'='*80}")
    ...
    print(f"\n{'='*80}")
    print(f"SETUP 2 COMPLETE — {total:.0f}s ({total/3600:.1f}h)")
